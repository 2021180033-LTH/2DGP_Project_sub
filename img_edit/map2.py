...
class Map2:
    def __init__(self):
        self.image1 = load_image("image/half_vertex_steel_block.png")
        self.image2 = load_image("image/quarter_vertex_steel_block.png")
        self.image3 = load_image("image/quarter_vertex_steel_block.png")
        self.image4 = load_image("image/vertical_steel_block.png")
        self.image5 = load_image("image/vertical_steel_block.png")
